...
describe("TimeLockPool", function () {
    ...
    before(async() => {
        ...
        const timeLockPoolFactory = await hre.ethers.getContractFactory("TimeLockPool");

        escrowPool = await hre.upgrades.deployProxy(timeLockPoolFactory,
            [
                "ESCROW",
                "ESCRW",
                rewardToken.address,
        ...
        timeLockPool = await hre.upgrades.deployProxy(timeLockPoolFactory,
            [
                "Staking Pool",
                "STK",
